...
echo "Gerei uma lista com detalhes da pasta HOME e redireciona para o arquivo lista_HOME.txt:" # 'echo' exibe a mensagem no terminal
...
echo "Data atual:"
date  # Comando que imprime a data atual na tela
